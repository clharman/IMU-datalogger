#addresses and commands for LSM303D magnetometer/accelerometer
...
#Magnetometer
m_on = 0x40		#power_on @ 100 Hz sampling, high magnetic resolution @ ctrl5
...
def m_init(bus, m_FS = m_FS_4g):	#returns conversion factor = gain (output will be mille-gauss)
	...
	bus.write_byte_data(adr, ctrl7, m_ctrl7)
	if(m_FS == m_FS_4g):
		m_gain = 0.160
	elif(m_FS == m_FS_2g):
		m_gain = 0.080
